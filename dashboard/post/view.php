...
<div class="main-content">
    ...
    <div class="row">
        ...
        <div class="col-xxl-4">
            <div class="panel">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" Method="post" enctype="multipart/form-data" id="view-post">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="old_post_featured_image">
                        </div>
                        <div class="mb-3">
