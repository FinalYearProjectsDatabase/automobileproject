...
<div class="main-content">
    ...
    <div class="row">
        ...
        <div class="col-xxl-4">
            <div class="panel">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" Method="post" enctype="multipart/form-data" id="view-user-client">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user_client_username" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" name="user_client_email" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Contact</label>
                            <input type="text" name="user_client_contact" class="form-control" required>
                        </div>
                    </div>
